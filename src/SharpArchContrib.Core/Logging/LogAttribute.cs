...
namespace SharpArchContrib.Core.Logging {
    ...
    public class LogAttribute : OnMethodBoundaryAspect {
        ...
        public override void OnEntry(MethodExecutionEventArgs eventArgs) {
            var logger = LogManager.GetLogger(eventArgs.Method.DeclaringType);
        ...
        public override void OnSuccess(MethodExecutionEventArgs eventArgs) {
            ...
            if (ShouldLog(logger, SuccessLevel, eventArgs)) {
                logger.Log(SuccessLevel, string.Format("{0} Returns:[{1}]", eventArgs.Method.Name, eventArgs.ReturnValue != null ? eventArgs.ReturnValue.ToString() : ""));    
            }
        }
        ...
        public override void OnException(MethodExecutionEventArgs eventArgs) {
            ...
            {
                ExceptionLogger.LogException(eventArgs.Exception, false, eventArgs.Instance.GetType());
            }
        }
